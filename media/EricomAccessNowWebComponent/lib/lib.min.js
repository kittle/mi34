 ...
 * Requires: 1.2.2+
 */
(function(c){function h(a){var b=a||window.event,i=[].slice.call(arguments,1),e=0,f=0,g=0;a=c.event.fix(b);a.type="mousewheel";if(b.wheelDelta)e=b.wheelDelta/120;if(b.detail)e=-b.detail/3;g=e;if(b.axis!==undefined&&b.axis===b.HORIZONTAL_AXIS){g=0;f=-1*e}if(b.wheelDeltaY!==undefined)g=b.wheelDeltaY/120;if(b.wheelDeltaX!==undefined)f=-1*b.wheelDeltaX/120;i.unshift(a,e||delatY||f,f,g);return(c.event.dispatch||c.event.handle).apply(this,i)}var d=["DOMMouseScroll","mousewheel"];if(c.event.fixHooks)for(var j=
d.length;j;)c.event.fixHooks[d[--j]]=c.event.mouseHooks;c.event.special.mousewheel={setup:function(){if(this.addEventListener)for(var a=d.length;a;)this.addEventListener(d[--a],h,false);else this.onmousewheel=h},teardown:function(){if(this.removeEventListener)for(var a=d.length;a;)this.removeEventListener(d[--a],h,false);else this.onmousewheel=null}};c.fn.extend({mousewheel:function(a){return a?this.bind("mousewheel",a):this.trigger("mousewheel")},unmousewheel:function(a){return this.unbind("mousewheel",
a)}})})(jQuery);
...
*/
(function(a,j){function k(){if(!a.postMessage||a.importScripts)return false;var c=true,d=a.onmessage;a.onmessage=function(){c=false};a.postMessage("","*");a.onmessage=d;return c}function l(c){c.setImmediate=a.msSetImmediate;c.clearImmediate=a.msClearImmediate}function m(c){var d=new a.MessageChannel;d.port1.onmessage=function(b){g.runIfPresent(b.data)};c.setImmediate=function(){var b=g.addFromSetImmediateArguments(arguments);d.port2.postMessage(b);return b}}function n(c){function d(f){if(f.source===
a&&typeof f.data==="string"&&f.data.substring(0,b.length)===b){f=f.data.substring(b.length);g.runIfPresent(f)}}var b="com.bn.NobleJS.setImmediate"+Math.random();a.addEventListener?a.addEventListener("message",d,false):a.attachEvent("onmessage",d);c.setImmediate=function(){var f=g.addFromSetImmediateArguments(arguments);a.postMessage(b+f,"*");return f}}function o(c){c.setImmediate=function(){var d=g.addFromSetImmediateArguments(arguments),b=document.createElement("script");b.onreadystatechange=function(){g.runIfPresent(d);
b.onreadystatechange=null;b.parentNode.removeChild(b);b=null};document.documentElement.appendChild(b);return d}}function p(c){c.setImmediate=function(){var d=g.addFromSetImmediateArguments(arguments);a.setTimeout(function(){g.runIfPresent(d)},0);return d}}var g=function(){function c(e,h){this.handler=e;this.args=Array.prototype.slice.call(h)}c.prototype.run=function(){typeof this.handler==="function"?this.handler.apply(j,this.args):eval(""+this.handler)};var d=1,b={},f=false;return{addFromSetImmediateArguments:function(e){var h=
e[0];e=Array.prototype.slice.call(e,1);h=new c(h,e);e=d++;b[e]=h;return e},runIfPresent:function(e){if(f)a.setTimeout(function(){g.runIfPresent(e)},0);else{var h=b[e];if(h){f=true;try{h.run()}finally{delete b[e];f=false}}}},remove:function(e){delete b[e]}}}();if(!a.setImmediate){var i=typeof Object.getPrototypeOf==="function"&&"setTimeout"in Object.getPrototypeOf(a)?Object.getPrototypeOf(a):a;if(a.msSetImmediate&&a.msClearImmediate)l(i);else{if(a.MessageChannel)m(i);else if(k())n(i);else"document"in
a&&"onreadystatechange"in a.document.createElement("script")?o(i):p(i);i.clearImmediate=g.remove}}})(this);